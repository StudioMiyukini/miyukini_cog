...
Ce document constitue l’**analyse des besoins** du public cible **Exposants** pour le service JayFestival. Il identifie l’ensemble des besoins fonctionnels et non fonctionnels, les parcours détaillés, les user stories, les pain points et opportunités, ainsi que la priorisation et les dépendances. Il s’adresse aux équipes produit, conception et développement.

**Références** : [Document fondateur](../../JayFestival%20-%20Document%20Fondateur.md), [Parcours, capacités et dashboard](./Exposants%20-%20Parcours%20Capacites%20Dashboard.md), [Politique de résidence des données sensibles](../../../../reference/Miyukini%20Conceptual%20References%20-%20Politique%20Residence%20Donnees%20Sensibles.md) (COG de référence, données exposant).
