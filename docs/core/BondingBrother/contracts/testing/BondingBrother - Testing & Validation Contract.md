...
Ce document s'appuie sur les [Invariants & Guarantees](../governance/BondingBrother%20-%20Invariants%20&%20Guarantees.md) pour définir ce qui doit être testé et le [Error & Rejection Model](../error/BondingBrother%20-%20Error%20&%20Rejection%20Model.md) pour les cas d'erreur à valider.

Les tests doivent valider le respect des [Lois d'Autonomie Système](../../../../reference/Miyukini%20Conceptual%20References%20-%20Lois%20Autonomie%20Systeme.md), notamment le fonctionnement en mode offline (**LOI-2**) et la souveraineté de l'état local (**LOI-3**).
...
**Couverture requise :** Métriques critiques définies dans [Performance & Scalability Contract](../performance/BondingBrother%20-%20Performance%20&%20Scalability%20Contract.md).
...
**Couverture requise :** Tous les vecteurs d'attaque documentés dans [Security & Threat Model Contract](../security/BondingBrother%20-%20Security%20&%20Threat%20Model%20Contract.md).
...
**Référence :** [Bilateral Flow Contract](../flows/BondingBrother%20-%20Bilateral%20Flow%20Contract.md)
...
**Référence :** [Intent Model Contract](../intent/BondingBrother%20-%20Intent%20Model%20Contract.md)
...
**Référence :** [Translation Contract](../intent/BondingBrother%20-%20Translation%20Contract.md)
...
**Référence :** [Error & Rejection Model](../error/BondingBrother%20-%20Error%20&%20Rejection%20Model.md)
...
**Référence :** [Offline & Deferred Authority Contract](../offline/BondingBrother%20-%20Offline%20&%20Deferred%20Authority%20Contract.md)
