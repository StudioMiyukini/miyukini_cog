...
### 2.1 Opérateur « JayFestival Organisateur » (tableau de bord organisateur)
...
Cet Opérateur est le **point d’entrée** principal de l’organisateur : il agrège la vue multi-éditions et délègue le détail par édition à JayFestival Édition.

### 2.2 Opérateur « JayFestival Édition » (dashboard par édition)
...
| **Lien avec JayFestival Organisateur** | JayFestival Organisateur **orchestre** l’accès aux éditions ; JayFestival Édition est **instancié par édition** (ou un seul Opérateur avec contexte édition). |

### 2.3 Synthèse des Opérateurs (public Organisateurs)

| Opérateur | Usage par l’organisateur | Livrables couverts |
|-----------|--------------------------|---------------------|
| **JayFestival Organisateur** | Connexion, liste des éditions, équipe, paramètres, publication catalogue. | Tableau de bord organisateur, multi-festivals. |
| **JayFestival Édition** | Dashboard par édition : exposants, plan de salle, programme, budget, documents, services visiteur, notifications. | Éditions, exposants, plan de salle, programme, budget, documents, services visiteur, publication. |

---

## 3. Besoins en Toolkits (public Organisateurs)

### 3.1 Kit « Éditions » (JayFestival)
...
| **Consommé par** | JayFestival Organisateur, JayFestival Édition. |
| **Composants sous-jacents** | KindMother. |

### 3.2 Kit « Exposants (côté organisateur) » (JayFestival)
...
### 3.6 Kit « Documents & Légal » (JayFestival)
...
### 3.7 Kit « Services visiteur » (JayFestival)
...
| **Consommé par** | JayFestival Édition. |
| **Composants sous-jacents** | KindMother ; Opérateur JayFestival Visiteur (consommation côté visiteur). |

### 3.8 Kit « Publication catalogue » (JayFestival)
...
| **Consommé par** | JayFestival Organisateur, JayFestival Édition ; Opérateur Catalogue (Façade publique). |
| **Composants sous-jacents** | KindMother, Border Guard (règles d’exposition). |

### 3.9 Kit « Équipe & Permissions » (JayFestival)
...
| **Consommé par** | JayFestival Organisateur. |
...
|---------|-----------------------------|---------------------|
| **Éditions** | JayFestival Organisateur, JayFestival Édition | Création, paramétrage, liste éditions, publication. |
| **Exposants (côté organisateur)** | JayFestival Édition | Candidatures, validation, refus, fiches, facturation. |
| **Plan de salle** | JayFestival Édition | Zones, stands, attribution, export. |
| **Programme** | JayFestival Édition | Animations, salles, horaires, vues. |
| **Budget** | JayFestival Édition | Revenus, dépenses, ventilation, balance. |
| **Documents & Légal** | JayFestival Édition | Contrats, CGV, conventions, partage. |
| **Services visiteur** | JayFestival Édition | Activation, paramétrage (jeux, concours, ateliers, pass). |
| **Publication catalogue** | JayFestival Organisateur, JayFestival Édition | Annuaire événements, répertoires. |
| **Équipe & Permissions** | JayFestival Organisateur | Équipe, rôles, éditions assignées. |
...
|----------------------|-----------|------------|
| Onboarding (inscription organisateur) | Miyauth, Miyuprofile ; JayFestival Organisateur | Équipe & Permissions, Éditions. |
| Liste des éditions (multi-festivals) | JayFestival Organisateur | Éditions. |
| Dashboard par édition | JayFestival Édition | Éditions, Exposants, Plan de salle, Programme, Budget, Documents, Services visiteur. |
| Candidatures exposants (validation, refus) | JayFestival Édition | Exposants (côté organisateur). |
| Plan de salle (zones, attribution) | JayFestival Édition | Plan de salle. |
| Programme (animations, horaires) | JayFestival Édition | Programme. |
| Budget (revenus, dépenses) | JayFestival Édition | Budget. |
| Documents (contrats, CGV) | JayFestival Édition | Documents & Légal. |
| Services visiteur (activation) | JayFestival Édition | Services visiteur. |
| Publication catalogue | JayFestival Organisateur, JayFestival Édition | Publication catalogue. |
| Équipe (rôles, bénévoles) | JayFestival Organisateur | Équipe & Permissions. |
