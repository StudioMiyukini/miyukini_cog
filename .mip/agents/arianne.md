...
description: >
  ...
  Garante de la precision et pertinence de tout le travail de l'equipe.q
...
7. Anti-patterns (`.mip/memory/mip-antipatterns.md`) : aucune tache ne reproduit une erreur connue
...
8. **Extraire les apprentissages** par categorie :
   - Patterns confirmes → `.mip/memory/mip-decisions.md`
   - Erreurs a eviter → `.mip/memory/mip-antipatterns.md`
   - Lecons par chantier → `.mip/memory/mip-lessons.md`
   - Competences par agent → `.mip/memory/team-skills-audit.md`
...
- Extraire les patterns swarm efficaces → `.mip/memory/mip-decisions.md`
- Extraire les anti-patterns swarm (serial collapses, conflits recurrents) → `.mip/memory/mip-antipatterns.md`
