...
- **[Miyukini Framework — Lois Autonomie Système](docs/reference/Miyukini%20Framework%20-%20Lois%20Autonomie%20Systeme.md)** : Les états illustrent notamment **LOI-2** (isolement comme état normal) et **LOI-3** (état local souverain) à travers les états d'autonomie et de désynchronisation des Instance Filles.
