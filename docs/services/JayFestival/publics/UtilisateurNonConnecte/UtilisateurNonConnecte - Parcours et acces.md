...
Ce document détaille le **parcours** et les **accès** du public **Utilisateur non connecté** dans le cadre du service JayFestival. Il complète le [document fondateur](../../JayFestival%20-%20Document%20Fondateur.md).
...
- [Document fondateur JayFestival](../../JayFestival%20-%20Document%20Fondateur.md) — § 3 Macro (Trois piliers du catalogue), § 7.2 Publics cibles
