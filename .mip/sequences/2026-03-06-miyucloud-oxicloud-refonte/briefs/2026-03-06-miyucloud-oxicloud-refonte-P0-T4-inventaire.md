# P0 Temps 4 -- Inventaire des prerequis (Denis + Hugo + Jean)
...
## ALERTE CRITIQUE
OxiCloud utilise axum 0.8.8 nativement. La decision "Migration actix-web -> axum" etait basee sur une information erronee. Impact : positif (moins de travail).
...
### Modules a creer
webdav/, caldav/, carddav/, dedup/, compression/, wopi/, thumbnails/ (dans crates/miyucloud)
webdav/, caldav/, carddav/, wopi/, api/calendars.rs, api/contacts.rs (dans apps/miyucloud)
