...
> **Les normes et standards du MWS garantissent l'interopérabilité, l'authenticité et l'intégrité des annonces de présence ; ils ne définissent pas la gouvernance des accès (Passeport, Permis de circulation, Visa de Connexion).**
...
**Règle :** cette déclaration **ne donne aucun droit d'accès** ; elle indique où se présenter pour demander un Permis de circulation (relay) ou un Visa de Connexion / accord d'hôte (COG hôte).
...
| **Pas de gouvernance** | Ne jamais décider d'accès (Permis de circulation, Visa de Connexion, Passeport) pour le métier ; le MWS délivre le Permis de circulation et applique le contrôle tracker ; ne pas exposer de données métier ni de gouvernance. |
