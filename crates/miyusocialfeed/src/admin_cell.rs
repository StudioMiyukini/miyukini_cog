...
pub struct MiyusocialfeedIdentification {
    pub id: String,
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyusocialfeedTestManifest {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyusocialfeedAdminCell {
    pub identification: MiyusocialfeedIdentification,
    pub test_manifest: MiyusocialfeedTestManifest,
    pub integrity: MiyusocialfeedIntegrity,
}
...
pub fn miyusocialfeed_admin_cell(version: &str, fingerprint: &str) -> MiyusocialfeedAdminCell {
    MiyusocialfeedAdminCell {
        identification: MiyusocialfeedIdentification {
            ...
            module_origin: "Miyusocialfeed".to_string(),
        },
        test_manifest: MiyusocialfeedTestManifest {
        ...
        integrity: MiyusocialfeedIntegrity {
            fingerprint: fingerprint.to_string(),
            contracts: vec!["Miyusocialfeed-Tool-Governance-Compliance".to_string()],
