...
pub struct MiyumoderationforumIdentification {
    pub id: String,
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyumoderationforumTestManifest {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyumoderationforumAdminCell {
    pub identification: MiyumoderationforumIdentification,
    pub test_manifest: MiyumoderationforumTestManifest,
    pub integrity: MiyumoderationforumIntegrity,
}
...
pub fn miyumoderationforum_admin_cell(
    ...
    MiyumoderationforumAdminCell {
        identification: MiyumoderationforumIdentification {
            ...
            module_origin: "Miyumoderationforum".to_string(),
        },
        test_manifest: MiyumoderationforumTestManifest {
        ...
        integrity: MiyumoderationforumIntegrity {
            fingerprint: fingerprint.to_string(),
            contracts: vec!["Miyumoderationforum-Tool-Governance-Compliance".to_string()],
