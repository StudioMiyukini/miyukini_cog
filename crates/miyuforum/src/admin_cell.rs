...
pub struct MiyuforumIdentification {
    pub id: String,
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyuforumTestManifest {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyuforumAdminCell {
    pub identification: MiyuforumIdentification,
    pub test_manifest: MiyuforumTestManifest,
    pub integrity: MiyuforumIntegrity,
}
...
pub fn miyuforum_admin_cell(version: &str, fingerprint: &str) -> MiyuforumAdminCell {
    MiyuforumAdminCell {
        identification: MiyuforumIdentification {
            ...
            module_origin: "Miyuforum".to_string(),
        },
        test_manifest: MiyuforumTestManifest {
            tests: vec![EmbeddedTestDef {
                id: "Miyuforum".to_string(),
                name: "Test chemin complet Miyuforum".to_string(),
                protocol: "invoke".to_string(),
                criteria: TestCriteria { pass: "all_steps_ok".to_string() },
            }],
            result_format: "json".to_string(),
        },
        integrity: MiyuforumIntegrity {
            fingerprint: fingerprint.to_string(),
            contracts: vec!["Miyuforum-Tool-Governance-Compliance".to_string()],
