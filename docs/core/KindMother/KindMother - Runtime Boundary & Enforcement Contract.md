...
- **[Miyukini Framework — Lois Autonomie Système](docs/reference/Miyukini%20Framework%20-%20Lois%20Autonomie%20Systeme.md)** : Ce contrat respecte **LOI-1** (aucune dépendance externe critique) et **LOI-6** (l'autonomie n'empêche pas la fédération) en garantissant que les Runtime Boundaries fonctionnent localement sans dépendance externe, et que le zero-trust interne préserve l'autonomie de chaque instance même dans une fédération.
