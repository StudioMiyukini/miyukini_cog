...
description: Architecture pyramidale Miyukini COG, strates 0-9, Cores systeme, Lois d'Autonomie LOI-1 a LOI-8, environnements souverains et gouvernance. Utiliser quand on prend des decisions architecturales, quand on cree ou modifie un crate, quand on travaille sur les Cores ou les interactions entre strates, ou quand on verifie la conformite architecturale.
---
...
- Pyramide complete : [references/pyramid.md](references/pyramid.md)
- Cores en detail : [references/cores.md](references/cores.md)
- Documentation officielle : `docs/reference/`
