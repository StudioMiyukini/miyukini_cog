...
pub fn tick(state: &mut GameState, delta_s: f64, game_speed: f64) {
    ...
    // ─── 3. Moral (bonheur) + Game Over ────────────────────────────────
    // @id: miyuclicker_idlesim_tick_moral
    ...
    // Nouveaux ouvriers apparaissent naturellement si nourriture > pop et place disponible.
    // @id: miyuclicker_idlesim_tick_growth
    // @do: grow_population_naturally_as_new_workers
    // @human: 0.1 × fécondité ouvriers/jour. Accumulateur fractionnaire.
    ...
    // ─── 5. Construction ───────────────────────────────────────────────
    // Chaque bâtisseur alloué = 1 pt/jour sur le bâtiment (seulement si payé).
    // @id: miyuclicker_idlesim_tick_construction
