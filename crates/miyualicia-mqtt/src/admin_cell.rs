...
#[must_use]
pub fn alicia_mqtt_admin_cell(version: &str, fingerprint: &str) -> AliciaMqttAdminCell {
    AliciaMqttAdminCell {
...
pub fn init_admin_cell(version: &str, fingerprint: &str) -> &'static AliciaMqttAdminCell {
