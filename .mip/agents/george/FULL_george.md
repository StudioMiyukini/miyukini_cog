...
description: >
  ...
  Rend un audit final a Denis et Arianne.
model: opus
...
- Rendre un **audit complet** a destination de Denis et Arianne
...
- L'audit final est adresse a **Denis** pour action et a **Arianne** pour archivage
