...
pub struct MiyubookmarksIdentification {
    pub id: String,
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyubookmarksTestManifest {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyubookmarksAdminCell {
    pub identification: MiyubookmarksIdentification,
    pub test_manifest: MiyubookmarksTestManifest,
    pub integrity: MiyubookmarksIntegrity,
}
...
pub fn miyubookmarks_admin_cell(version: &str, fingerprint: &str) -> MiyubookmarksAdminCell {
    MiyubookmarksAdminCell {
        identification: MiyubookmarksIdentification {
            ...
            module_origin: "Miyubookmarks".to_string(),
        },
        test_manifest: MiyubookmarksTestManifest {
        ...
        integrity: MiyubookmarksIntegrity {
            fingerprint: fingerprint.to_string(),
            contracts: vec!["Miyubookmarks-Tool-Governance-Compliance".to_string()],
