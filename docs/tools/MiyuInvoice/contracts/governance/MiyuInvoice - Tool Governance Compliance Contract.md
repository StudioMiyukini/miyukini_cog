# MiyuInvoice — Tool Governance Compliance Contract
...
## Obligations spécifiques MiyuInvoice

- Permissions (qui peut émettre/modifier factures) = **Master Butler** + **StrongFather**.
