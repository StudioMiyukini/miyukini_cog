...
Conformément au [Protocole d’écriture de la documentation conceptuelle](../../../protocols/Miyukini%20Prompt%20Protocol%20-%20Ecriture%20Documentation%20Conceptuelle.md) : **documentation autorisée** — Document fondateur JayKonta, Politique de résidence, Glossaire Miyukini, Points d’entrée JayBudget et JayKonta. **Contraintes** : ne pas fusionner avec le Document fondateur ; ne pas anticiper l’implémentation (contrats d’Opérateurs/Kits).
...
|----------------|------------------|----------------|
| **JayBudget** | Mouvements personnels, budgets occasionnels, catégories, objectifs | 2 (Sensitive) |
| **JayKonta** | Devis, factures, comptabilité d’entreprise, rapports légaux, moyens de paiement | 2–3 (Sensitive à Critical) |
...
## 3. Règles de sécurité spécifiques JayKonta
...
En cas de dégradation de l’intégrité du système (états de confiance T1–T4 gouvernés par WorrySentinel), les capacités de JayKonta peuvent être restreintes :

| État | Effet possible sur JayKonta |
|------|------------------------------------|
...
Caring Nanny et WorrySentinel gouvernent ces restrictions ; JayKonta ne décide pas seul.
...
| Document | Rôle |
|----------|------|
| [JayKonta - Document Fondateur](../JayKonta%20-%20Document%20Fondateur.md) | Contexte, besoins, positionnement, sécurité synthétique. |
...
**Document** : JayKonta — Niveaux de sécurité et protection des données  
**Version** : 1.1  
**Date** : 2026-01-31  
