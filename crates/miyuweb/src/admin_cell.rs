...
pub struct MiyuwebIdentification {
    pub id: String,
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyuwebTestManifest {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyuwebAdminCell {
    pub identification: MiyuwebIdentification,
    pub test_manifest: MiyuwebTestManifest,
    pub integrity: MiyuwebIntegrity,
}
...
pub fn miyuweb_admin_cell(version: &str, fingerprint: &str) -> MiyuwebAdminCell {
    MiyuwebAdminCell {
        identification: MiyuwebIdentification {
            ...
            module_origin: "Miyuweb".to_string(),
        },
        test_manifest: MiyuwebTestManifest {
        ...
        integrity: MiyuwebIntegrity {
            fingerprint: fingerprint.to_string(),
            contracts: vec!["Miyuweb-Tool-Governance-Compliance".to_string()],
