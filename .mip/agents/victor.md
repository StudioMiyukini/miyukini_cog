...
- **Maintenir la base de connaissances securite** : `.mip/memory/security-patterns.md`
...
Artefact : section securite dans `<sequence>/audits/YYYY-MM-DD-<slug>.md`
...
- **MEMOIRE** : Maintenir `.mip/memory/security-patterns.md` avec les patterns, erreurs securite et exigences certifications
...
9. **(P6)** Transmettre les patterns securite et exigences certifications a Arianne pour capitalisation dans `.mip/memory/security-patterns.md`
