...
pub struct MiyuValidateIdentification {
    pub id: String,
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyuValidateTestManifest {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyuValidateIntegrity {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyuValidateAdminCell {
    pub identification: MiyuValidateIdentification,
    pub test_manifest: MiyuValidateTestManifest,
    pub integrity: MiyuValidateIntegrity,
}
...
pub fn miyuvalidate_admin_cell(version: &str, fingerprint: &str) -> MiyuValidateAdminCell {
    MiyuValidateAdminCell {
        identification: MiyuValidateIdentification {
            ...
            module_origin: "miyukini-miyuvalidate".to_string(),
        },
        test_manifest: MiyuValidateTestManifest {
        ...
        integrity: MiyuValidateIntegrity {
            fingerprint: fingerprint.to_string(),
            contracts: vec!["MiyuValidate-Tool-Governance-Compliance".to_string()],
