...
pub fn api_routes_list() -> Vec<(&'static str, &'static str, &'static str)> {
    vec![
        ...
        (
            "GET",
            "/api/jaymanga/catalog/works/{work_id}",
            "Fiche oeuvre",
        ),
        (
            "GET",
            "/api/jaymanga/catalog/series/{series_id}",
            "Série avec volumes",
        ),
        ...
        (
            "GET",
            "/api/jaymanga/media/page/{page_id}",
            "Image de page (variante auto)",
        ),
        (
            "GET",
            "/api/jaymanga/media/page/{page_id}/{profile}",
            "Variante spécifique",
        ),
        ...
        (
            "POST",
            "/api/jaymanga/reader/progress",
            "Sauvegarder progression",
        ),
        (
            "GET",
            "/api/jaymanga/reader/progress/{work_id}",
        ...
        (
            "POST",
            "/api/jaymanga/webhook/{gateway}",
            "Callback passerelle",
        ),
        (
            "GET",
            "/api/jaymanga/license/verify/{content_id}",
            "Vérifier licence",
        ),
        // Fédération
        ...
        (
            "GET",
            "/api/jaymanga/federation/catalog",
            "Catalogue fédéré",
        ),
        (
            "GET",
            "/api/jaymanga/federation/catalog/since/{ts}",
            "Delta catalogue",
        ),
        // Présence
