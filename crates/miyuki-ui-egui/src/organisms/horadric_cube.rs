    ...
    pub fn show(ctx: &Context, is_open: &mut bool) -> bool {
        ...
        egui::Window::new("Cube Horadrique")
            ...
            .show(ctx, |ui| {
                ...
                let (resp, painter) =
                    ui.allocate_painter(egui::Vec2::new(grid_w, grid_h), egui::Sense::click());
                ...
                for col in 0..=CUBE_COLS {
                    ...
                    painter.line_segment(
                        [
                            egui::Pos2::new(x, origin.y),
                            egui::Pos2::new(x, origin.y + grid_h),
                        ],
                ...
                for row in 0..=CUBE_ROWS {
                    ...
                    painter.line_segment(
                        [
                            ...
                            egui::Pos2::new(origin.x + grid_w, y),
                        ],
                        egui::Stroke::new(0.5, line_color),
                    );
                }
