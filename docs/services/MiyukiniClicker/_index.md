...
- **Stack :** Rust, egui/eframe, pack UI open-source à licence permissive.
...
2. **[État des lieux](MiyuClicker%20-%20Etat%20des%20Lieux.md)** — Ce qui est fait / partiel / non fait (code vs spec).
3. **[Architecture technique actuelle](MiyuClicker%20-%20Architecture%20Technique%20Actuelle.md)** — Modules, flux d’appel, où se trouve la logique.
4. **[Guide Implementation MVP](MiyuClicker%20-%20Guide%20Implementation%20MVP.md)** — Modèle d’état, specs écrans, APIs, phases.
5. Autres docs selon le besoin (Zone Cité, Bâtiments, Audit, Packs UI, etc.).
...
| [MiyuClicker - Operateurs et Toolkits](MiyuClicker%20-%20Operateurs%20et%20Toolkits.md) | Mapping Opérateurs et Toolkits pour le MVP : Toolkits à utiliser (egui/eframe) ou créer (Sprites, IdleSim, Save, Combat, Carte) ; Opérateurs (UI, Sim, Save, Combat, Carte) ; Service MiyuClicker. |
...
- [Stack UI egui / eframe](../../ux_ui/Miyukini%20-%20Stack%20UI%20egui%20eframe.md) — Stack UI officielle Miyukini.
