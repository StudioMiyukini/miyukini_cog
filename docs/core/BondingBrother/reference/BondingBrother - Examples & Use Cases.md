...
Les exemples illustrent le respect des [Lois d'Autonomie Système](../../../reference/Miyukini%20Conceptual%20References%20-%20Lois%20Autonomie%20Systeme.md), notamment le fonctionnement en mode offline (**LOI-2**) et la souveraineté de l'état local (**LOI-3**).
