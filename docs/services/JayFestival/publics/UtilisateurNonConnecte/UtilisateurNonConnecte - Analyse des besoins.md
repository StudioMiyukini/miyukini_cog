...
Ce document constitue l’**analyse des besoins** du public cible **Utilisateur non connecté** pour le service JayFestival. Il identifie l’ensemble des besoins fonctionnels et non fonctionnels liés à la **Façade publique gouvernée** (catalogue en lecture seule), les parcours de découverte, les user stories, les pain points et opportunités, ainsi que la priorisation et les dépendances. Il s’adresse aux équipes produit, conception et développement.

**Références** : [Document fondateur](../../JayFestival%20-%20Document%20Fondateur.md), [Parcours et accès](./UtilisateurNonConnecte%20-%20Parcours%20et%20acces.md).
