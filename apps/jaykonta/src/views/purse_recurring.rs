        ...
        div {
            ...
            div {
                ...
                for item in incomes.into_iter() {
                    { render_recurring_row(&item, &c, db.clone(), refresh_tick) }
                }
            }
...
fn render_recurring_row(
    ...
    db: Arc<jaykonta::data::JayKontaDb>,
            ...
            div {
                ...
                div {
                    ...
                    button {
                        ...
                        onclick: move |_| {
                            let _ = db1.toggle_recurring(&item_id, !item_active);
                            refresh_tick.set(refresh_tick() + 1);
                        },
                    ...
                    button {
                        ...
                        onclick: move |_| {
                            let _ = db2.delete_recurring(&item_id2);
                            refresh_tick.set(refresh_tick() + 1);
                        },
                        "🗑"
                    }
