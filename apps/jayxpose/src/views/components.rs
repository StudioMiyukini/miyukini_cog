...
pub fn DocumentRow(
    ...
    let (status_color, status_label) = match status.as_str() {
        "valide" => (c.accent_green, "Valide"),
        "en_attente" => (c.accent_orange, "En attente"),
        "expire" => (c.accent_red, "Expire"),
        "rejete" => (c.accent_red, "Rejete"),
    ...
    rsx! {
        div {
            style: "display: flex; align-items: center; gap: 12px; padding: 12px 16px; background: {c.bg_hover}; border-radius: 4px;",
            ...
            div {
                ...
                button {
                    style: "padding: 6px 10px; background: transparent; border: 1px solid {c.border}; border-radius: 4px; color: {c.text_secondary}; cursor: pointer; font-size: 11px;",
