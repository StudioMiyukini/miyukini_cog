...
- Gouvernance (WriteIntent, StrongFather, MasterButler, WorrySentinel) = 0 pourcent
- Export iCal = 0 pourcent
- Conflits cross-agendas = 0 pourcent
- Liaison Central profile_service_refs = 0 pourcent
- Tests = 0 pourcent
- Filtres UI avances = 0 pourcent
...
Toutes les ecritures SQLite dans kindmother_db.rs sont directes. Aucune ne passe par WriteIntent ni CoreDataAPI.

Fichier : crates/jaykoa/src/data/kindmother_db.rs lignes 122-288

Action : Wrapper chaque methode CRUD pour construire un WriteIntent avant SQL.

Priorite : MVP obligatoire

### 1.2 StrongFather - Decisions

Aucune validation de decision avant les operations. Crate : crates/strongfather/.
...
### 6.1 Vue Annee - Priorite : Phase 3

### 6.2 Filtres source/type (AGD-UI-04) - Priorite : MVP

### 6.3 Indicateur prochaine entree (AGD-UI-05) - Priorite : Post-MVP

### 6.4 Vue Liste/Agenda (AGD-UI-07) - Priorite : Phase 2

### 6.5 Indicateur libre/occupe (AGD-UI-08) - Priorite : Phase 2

### 6.6 Catalogue evenements publics (AGD-UI-09/10) - Priorite : Phase 2
...
### 7.2 Kits d'Outils - Priorite : Post-MVP
...
### 8.1 AGD-SEC-1 : References seulement - Priorite : Post-MVP
### 8.2 AGD-SEC-2 : Mandat pour agregation - Priorite : Post-MVP
### 8.3 AGD-SEC-3 : Export filtre par niveau - Priorite : MVP
### 8.4 AGD-SEC-5 : Niveau declare par source - Priorite : Post-MVP

---

## AXE 9 - Qualite et Maintenabilite

### 9.1 Tests unitaires - 0 test. Priorite : MVP
### 9.2 Tests d'integration - Priorite : Post-MVP
### 9.3 README du crate - Aucun. Priorite : MVP
### 9.4 Code mort - 5 helpers inutilises types.rs:357-385. Priorite : MVP
### 9.5 Fonctions DB inutilisees - entries_by_agenda, reflect_clear_service. Priorite : Basse
### 9.6 Dependance serde_json inutilisee - Priorite : MVP
### 9.7 MSCM annotations incompletes - Priorite : Basse

---

## AXE 10 - Parcours utilisateurs complets

### 10.1 Decouvrir evenements publics - Priorite : Phase 2
### 10.2 Partage agenda - Priorite : Phase 2
