...
Ce document complète l'[Architecture et Composants](./BondingBrother%20-%20Architecture%20et%20Composants.md) et les [Invariants et Garanties](./BondingBrother%20-%20Invariants%20et%20Garanties.md) en fournissant des directives concrètes d'implémentation.

L'implémentation doit respecter les [Lois d'Autonomie Système](../reference/Miyukini%20Framework%20-%20Lois%20Autonomie%20Systeme.md) : aucune dépendance externe critique (**LOI-1**), fonctionnement en mode offline (**LOI-2**), état local souverain (**LOI-3**), et coût proportionnel au hardware (**LOI-5**).
...
Utiliser des types d'erreur explicites et conformes au Error & Rejection Model.
