...
Ce document complète la [Documentation Fondatrice](../../foundation/BondingBrother%20-%20Documentation%20Fondatrice.md) et s'appuie sur le [Bilateral Flow Contract](../flows/BondingBrother%20-%20Bilateral%20Flow%20Contract.md) pour définir les métriques de performance des flux.
...
**Conformité autonomie :** Ce principe garantit **LOI-5** : la consommation de ressources est prévisible et maîtrisée, permettant le fonctionnement sur hardware simple (Raspberry Pi, mini PC, etc.). Voir les [Lois d'Autonomie Système](../../../reference/Miyukini%20Conceptual%20References%20-%20Lois%20Autonomie%20Systeme.md).
