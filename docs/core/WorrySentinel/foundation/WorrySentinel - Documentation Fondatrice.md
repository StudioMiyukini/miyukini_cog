...
- **LogisticsSteward — Documentation Fondatrice** : WorrySentinel supervise LogisticsSteward pour détecter les dérives d'allocation et peut imposer un durcissement des règles d'arbitrage
...
WorrySentinel et LogisticsSteward sont **complémentaires** :

- **WorrySentinel** : Gouverne les niveaux de sécurité et les états de confiance, supervise la cohérence globale du système
...
1. **Invalidation d'état incohérent** : WorrySentinel peut invalider un état système jugé incohérent par LogisticsSteward si cet état compromet l'intégrité sécuritaire
2. **Durcissement des règles** : En cas de dégradation de l'état de confiance (T1+), WorrySentinel peut déclencher un durcissement des règles d'arbitrage de LogisticsSteward
3. **Supervision des dérives** : WorrySentinel supervise les dérives potentielles dans l'allocation des ressources qui pourraient compromettre la sécurité
...
**Principe :** WorrySentinel supervise LogisticsSteward sans se substituer à lui. LogisticsSteward reste souverain sur l'arbitrage des ressources, mais doit adapter ses décisions selon les contraintes sécuritaires imposées par WorrySentinel.
...
**Origine :** Intégration du nouveau core LogisticsSteward dans l'écosystème

**Modifications apportées :**

1. **Section 1 : Relation avec les autres contrats**
   - Ajout de la référence à LogisticsSteward — Documentation Fondatrice

2. **Section 9 : Relation avec LogisticsSteward**
   - Nouvelle sous-section décrivant la relation de supervision
   - WorrySentinel supervise LogisticsSteward pour détecter les dérives d'allocation
   - WorrySentinel peut imposer un durcissement des règles d'arbitrage en état T1+
   - Règles d'interaction RÈGLE-WS-LS-1 à RÈGLE-WS-LS-4

3. **Section 9 : Flux de gouvernance**
   - Flux descendant : ajout de LogisticsSteward → durcissement quotas et priorités
   - Flux montant : ajout de LogisticsSteward → dérives allocation ressources

**Cohérence vérifiée :**
- ✅ Compatible avec LogisticsSteward — Documentation Fondatrice
- ✅ Séparation des responsabilités préservée (supervision vs arbitrage)
- ✅ Flux bidirectionnel documenté
- ✅ Règles d'interaction explicites
