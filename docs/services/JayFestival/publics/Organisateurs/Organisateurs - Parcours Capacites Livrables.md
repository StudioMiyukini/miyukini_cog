...
Ce document détaille le **parcours**, les **capacités** et les **livrables** du public cible **Organisateurs** dans le cadre du service JayFestival. Il complète le [document fondateur](../../JayFestival%20-%20Document%20Fondateur.md).
...
- [Document fondateur JayFestival](../../JayFestival%20-%20Document%20Fondateur.md) — § 4 Distribution organisateur
