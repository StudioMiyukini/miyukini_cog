...
pub struct MiyuwidgetsIdentification {
    pub id: String,
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyuwidgetsTestManifest {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyuwidgetsIntegrity {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyuwidgetsAdminCell {
    pub identification: MiyuwidgetsIdentification,
    pub test_manifest: MiyuwidgetsTestManifest,
    pub integrity: MiyuwidgetsIntegrity,
}
...
pub fn miyuwidgets_admin_cell(version: &str, fingerprint: &str) -> MiyuwidgetsAdminCell {
    MiyuwidgetsAdminCell {
        identification: MiyuwidgetsIdentification {
            ...
            module_origin: "Miyuwidgets".to_string(),
        },
        test_manifest: MiyuwidgetsTestManifest {
            tests: vec![EmbeddedTestDef {
                id: "Miyuwidgets".to_string(),
                name: "Test chemin complet Miyuwidgets".to_string(),
        ...
        integrity: MiyuwidgetsIntegrity {
            fingerprint: fingerprint.to_string(),
            contracts: vec!["Miyuwidgets-Tool-Governance-Compliance".to_string()],
