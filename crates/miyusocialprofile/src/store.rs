...
pub(crate) fn profiles() -> &'static Mutex<HashMap<String, HashMap<String, String>>> {
    static P: std::sync::OnceLock<Mutex<HashMap<String, HashMap<String, String>>>> = std::sync::OnceLock::new();
...
pub(crate) fn followers() -> &'static Mutex<HashMap<String, Vec<String>>> {
    static FW: std::sync::OnceLock<Mutex<HashMap<String, Vec<String>>>> = std::sync::OnceLock::new();
