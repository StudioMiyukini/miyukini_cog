...
pub(crate) fn usernotes_by_user() -> &'static Mutex<HashMap<String, Vec<String>>> {
    static UB: std::sync::OnceLock<Mutex<HashMap<String, Vec<String>>>> = std::sync::OnceLock::new();
...
pub(crate) fn bans() -> &'static Mutex<HashMap<String, (String, String, Option<String>)>> {
    static B: std::sync::OnceLock<Mutex<HashMap<String, (String, String, Option<String>)>>> = std::sync::OnceLock::new();
