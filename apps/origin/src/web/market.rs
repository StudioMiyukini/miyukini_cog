...
fn official_catalog_seed() -> Vec<ServiceManifest> {
    use miyumarket::manifest::ServicePermission;
    ...
    vec![
        ServiceManifest {
            ...
            developer: "Miyukini".into(), min_central_version: "0.1.0".into(),
            dependencies: vec![], permissions: vec![ServicePermission::Storage, ServicePermission::Webway],
        ...
        ServiceManifest {
            ...
            description: "Festivals, \u{00e9}ditions, exposants, visiteurs".into(),
            ...
            tags: vec!["festival".into(), "evenement".into()],
            homepage: None, checksum: None, package_size: None,
        },
        ServiceManifest {
            id: "jaykoa".into(), name: "JayKoa".into(),
            description: "Calendrier universel du COG, r\u{00e9}cepteur temporel transversal".into(),
            icon: "\u{1F4C6}".into(), version: "0.1.0".into(),
            service_type: ServiceType::InterneCog, source: ServiceSource::Officiel,
            developer: "Miyukini".into(), min_central_version: "0.1.0".into(),
            dependencies: vec![], permissions: vec![ServicePermission::Storage, ServicePermission::Calendar],
            tags: vec!["calendrier".into(), "planning".into()],
            homepage: None, checksum: None, package_size: None,
        },
        ServiceManifest {
            id: "jaykonta".into(), name: "JayKonta".into(),
            description: "Comptabilit\u{00e9} COG unifi\u{00e9}e Purse + Account".into(),
            ...
            tags: vec!["comptabilite".into(), "finance".into()],
            homepage: None, checksum: None, package_size: None,
        },
        ServiceManifest {
            id: "miyukiniwatch".into(), name: "MiyukiniWatch".into(),
            description: "Tes habitudes et tes mesures \u{2014} consulte, comprends, efface.".into(),
            icon: "\u{1F441}".into(), version: "0.1.0".into(),
            service_type: ServiceType::InterneCog, source: ServiceSource::Officiel,
            developer: "Miyukini".into(), min_central_version: "0.1.0".into(),
            dependencies: vec![], permissions: vec![ServicePermission::Storage, ServicePermission::Identity],
            tags: vec!["metriques".into(), "habitudes".into(), "vie-privee".into()],
            homepage: None, checksum: None, package_size: None,
        },
        ServiceManifest {
            id: "jay1tribu".into(), name: "Jay1Tribu".into(),
            description: "Tribus, amis et discussions \u{2014} chat et tribu pleins uniquement si connect\u{00e9} au Webway.".into(),
            ...
            tags: vec!["chat".into(), "amis".into(), "tribu".into(), "social".into()],
            homepage: None, checksum: None, package_size: None,
        },
        ServiceManifest {
            id: "jaymanga".into(), name: "JayManga".into(),
            description: "Lecture et vente de manga en ligne \u{2014} catalogue, lecteur, boutique, portail agr\u{00e9}g\u{00e9}".into(),
            icon: "\u{1F4DA}".into(), version: "0.1.0".into(),
            service_type: ServiceType::SurfaceWeb, source: ServiceSource::Officiel,
            developer: "Miyukini".into(), min_central_version: "0.1.0".into(),
            dependencies: vec![], permissions: vec![ServicePermission::Storage, ServicePermission::Webway],
            tags: vec!["manga".into(), "lecture".into(), "boutique".into()],
            homepage: None, checksum: None, package_size: None,
        },
        ServiceManifest {
            id: "miyuclicker".into(), name: "Lord of the Click".into(),
            description: "Premier jeu officiel Miyukini (Idle/Clicker + Carte strat\u{00e9}gique)".into(),
            icon: "\u{1F3AE}".into(), version: "0.1.0".into(),
            service_type: ServiceType::InterCog, source: ServiceSource::Officiel,
            developer: "Miyukini".into(), min_central_version: "0.1.0".into(),
            dependencies: vec![], permissions: vec![ServicePermission::Storage, ServicePermission::Webway],
            tags: vec!["jeu".into(), "clicker".into(), "idle".into()],
            homepage: None, checksum: None, package_size: None,
        },
        ServiceManifest {
            ...
            developer: "Miyukini".into(), min_central_version: "0.1.0".into(),
            dependencies: vec![], permissions: vec![ServicePermission::Storage, ServicePermission::Webway],
            tags: vec!["jeu".into(), "tower-defense".into(), "survivor".into()],
            homepage: None, checksum: None, package_size: None,
        },
    ]
}
