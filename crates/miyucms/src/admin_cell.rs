...
pub struct MiyucmsIdentification {
    pub id: String,
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyucmsTestManifest {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyucmsAdminCell {
    pub identification: MiyucmsIdentification,
    pub test_manifest: MiyucmsTestManifest,
    pub integrity: MiyucmsIntegrity,
}
...
pub fn miyucms_admin_cell(version: &str, fingerprint: &str) -> MiyucmsAdminCell {
    MiyucmsAdminCell {
        identification: MiyucmsIdentification {
            ...
            module_origin: "Miyucms".to_string(),
        },
        test_manifest: MiyucmsTestManifest {
        ...
        integrity: MiyucmsIntegrity {
            fingerprint: fingerprint.to_string(),
            contracts: vec!["Miyucms-Tool-Governance-Compliance".to_string()],
