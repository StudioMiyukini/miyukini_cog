        ...
        div {
            ...
            FormSection { title: "Informations boutique".to_string(),
                ...
                div {
                    ...
                    FormField {
                        label: "Pages démo (défaut)".to_string(),
                    ...
                    div {
                        ...
                        button {
                            ...
                            if *allow_aggregation.read() { "✅ Oui" } else { "❌ Non" }
                        }
                    }
                }
            }
            ...
            div {
                ...
                ActionButton {
                    ...
                    onclick: move |_| {
                        ...
                        let _ = db.seller_config_upsert(&seller);
                        ...
                        let _ = db.optimization_config_upsert(&opt);
                    },
                }
            }
        }
