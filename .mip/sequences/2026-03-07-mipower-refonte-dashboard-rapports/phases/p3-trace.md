...
| BUF — Corrections post-P4 | En attente | Francois + Lise | apres audit P4 |

## Livrable P3
- `src/api.rs` : derive_status, progress P0/P3/BUF/P4/P5/P6, artefacts {path,done}, 14 tests
- `static/index.html` : sortBy, prev/next, progress-pills, cache-busting ?v=0.3.0
- `static/app.js` : sortSequences, renderProgressPills, nav prev/next, Alt+arrow
- `static/app.css` : badges statut, progress pills, tree-item done/pending, btn-nav
