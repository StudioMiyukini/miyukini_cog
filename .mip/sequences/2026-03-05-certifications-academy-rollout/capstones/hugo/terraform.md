# Capstone Evidence - Terraform

**Cert ID**: cert.hugo.terraform
**Agent**: hugo
**Wave**: wave-04-platform-ops
**Status**: COMPLETED
...
- [x] Contexte et perimetre de la mission
  - Perimetre: certification cert.hugo.terraform dans le parcours academy local.
- [x] Decisions techniques/cadrage prises
  - Decision: appliquer le bloc prioritaire M1 -> HCL syntax, modules, variables and outputs.
...
- Target proof: Build reusable IaC modules
- Assessment: ../../../../certifications/terraform/academy/ASSESSMENT.md
- Sources: ../../../../certifications/sources/hugo.md
