# Miyukini — Comportement des COG et schéma des environnements
...
![Schéma architectural des environnements COG — COG A, COG B, COG Officiel, COG Tracker](../assets/Miyukini-Schema-Comportement-Environnements-COG.png)
...
| 3 | Services / Applications | Agissent uniquement dans le cadre du Visa (voir [Connexion Inter-COG](Miyukini%20-%20Connexion%20Inter-COG.md)). |
...
| **Souveraineté** | Hébergeur maître des données | **État local souverain** ; chaque COG garde sa gouvernance (voir [Souveraineté Environnement](Miyukini%20-%20Souverainete%20Environnement.md)). |
...
- [Connexion Inter-COG](Miyukini%20-%20Connexion%20Inter-COG.md) — Passeport, Visa, visite gouvernée, utilisateurs externes.
- [Souveraineté Environnement](Miyukini%20-%20Souverainete%20Environnement.md) — Entité souveraine, versionnée, isolée.
- [Definition COG](Miyukini%20-%20Definition%20COG.md) — Définition du COG et de la pyramide.
- [Pyramide Architecture Complete](Miyukini%20-%20Pyramide%20Architecture%20Complete.md) — Strates et position des Cores, BondingBrother, Opérateurs.

---

*Document public — Dernière mise à jour : 2026-02-08*
