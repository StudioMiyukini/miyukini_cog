...
Les migrations respectent les [Lois d'Autonomie Système](../reference/Miyukini%20Framework%20-%20Lois%20Autonomie%20Systeme.md) : elles peuvent être effectuées localement sans dépendance externe (**LOI-1**), et le système continue de fonctionner même en mode offline pendant la migration (**LOI-2**).
...
- Les règles de versionnement (voir Versioning & Evolution Contract)
...
**Dépendances :** 
- Versioning & Evolution Contract v1.0
