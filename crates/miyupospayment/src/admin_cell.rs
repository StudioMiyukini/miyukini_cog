...
pub struct MiyupospaymentIdentification {
    pub id: String,
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyupospaymentTestManifest {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyupospaymentIntegrity {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyupospaymentAdminCell {
    pub identification: MiyupospaymentIdentification,
    pub test_manifest: MiyupospaymentTestManifest,
    pub integrity: MiyupospaymentIntegrity,
}
...
pub fn miyupospayment_admin_cell(version: &str, fingerprint: &str) -> MiyupospaymentAdminCell {
    MiyupospaymentAdminCell {
        identification: MiyupospaymentIdentification {
            ...
            module_origin: "Miyupospayment".to_string(),
        },
        test_manifest: MiyupospaymentTestManifest {
            tests: vec![EmbeddedTestDef {
                id: "Miyupospayment".to_string(),
                name: "Test chemin complet Miyupospayment".to_string(),
                protocol: "invoke".to_string(),
                criteria: TestCriteria { pass: "all_steps_ok".to_string() },
            }],
            result_format: "json".to_string(),
        },
        integrity: MiyupospaymentIntegrity {
            fingerprint: fingerprint.to_string(),
            contracts: vec!["Miyupospayment-Tool-Governance-Compliance".to_string()],
