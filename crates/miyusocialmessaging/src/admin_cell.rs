...
pub struct MiyusocialmessagingIdentification {
    pub id: String,
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyusocialmessagingTestManifest {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyusocialmessagingAdminCell {
    pub identification: MiyusocialmessagingIdentification,
    pub test_manifest: MiyusocialmessagingTestManifest,
    pub integrity: MiyusocialmessagingIntegrity,
}
...
pub fn miyusocialmessaging_admin_cell(version: &str, fingerprint: &str) -> MiyusocialmessagingAdminCell {
    MiyusocialmessagingAdminCell {
        identification: MiyusocialmessagingIdentification {
            ...
            module_origin: "Miyusocialmessaging".to_string(),
        },
        test_manifest: MiyusocialmessagingTestManifest {
        ...
        integrity: MiyusocialmessagingIntegrity {
            fingerprint: fingerprint.to_string(),
            contracts: vec!["Miyusocialmessaging-Tool-Governance-Compliance".to_string()],
