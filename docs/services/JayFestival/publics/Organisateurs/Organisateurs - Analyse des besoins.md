...
Ce document constitue l’**analyse des besoins** du public cible **Organisateurs** pour le service JayFestival. Il identifie l’ensemble des besoins fonctionnels et non fonctionnels, les parcours détaillés, les user stories, les pain points et opportunités, ainsi que la priorisation et les dépendances. Il s’adresse aux équipes produit, conception et développement.

**Références** : [Document fondateur](../../JayFestival%20-%20Document%20Fondateur.md), [Parcours, capacités et livrables](./Organisateurs%20-%20Parcours%20Capacites%20Livrables.md).
