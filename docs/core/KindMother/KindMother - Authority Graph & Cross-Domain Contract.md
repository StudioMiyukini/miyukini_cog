...
- **[Miyukini Framework — Lois Autonomie Système](docs/reference/Miyukini%20Framework%20-%20Lois%20Autonomie%20Systeme.md)** : Ce contrat respecte **LOI-6** (l'autonomie n'empêche pas la fédération) en garantissant que chaque Authority Domain reste autonome tout en permettant une fédération contrôlée via des Intentions Certifiées, avec communication explicite, contrôlée, observable, et réversible.
