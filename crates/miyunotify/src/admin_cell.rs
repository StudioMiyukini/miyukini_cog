...
pub struct MiyunotifyIdentification {
    pub id: String,
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyunotifyTestManifest {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyunotifyAdminCell {
    pub identification: MiyunotifyIdentification,
    pub test_manifest: MiyunotifyTestManifest,
    pub integrity: MiyunotifyIntegrity,
}
...
pub fn miyunotify_admin_cell(version: &str, fingerprint: &str) -> MiyunotifyAdminCell {
    MiyunotifyAdminCell {
        identification: MiyunotifyIdentification {
            ...
            module_origin: "Miyunotify".to_string(),
        },
        test_manifest: MiyunotifyTestManifest {
        ...
        integrity: MiyunotifyIntegrity {
            fingerprint: fingerprint.to_string(),
            contracts: vec!["Miyunotify-Tool-Governance-Compliance".to_string()],
