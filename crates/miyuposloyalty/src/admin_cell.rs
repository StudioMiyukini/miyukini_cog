...
pub struct MiyuposloyaltyIdentification {
    pub id: String,
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyuposloyaltyTestManifest {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MiyuposloyaltyAdminCell {
    pub identification: MiyuposloyaltyIdentification,
    pub test_manifest: MiyuposloyaltyTestManifest,
    pub integrity: MiyuposloyaltyIntegrity,
}
...
pub fn miyuposloyalty_admin_cell(version: &str, fingerprint: &str) -> MiyuposloyaltyAdminCell {
    MiyuposloyaltyAdminCell {
        identification: MiyuposloyaltyIdentification {
            ...
            module_origin: "Miyuposloyalty".to_string(),
        },
        test_manifest: MiyuposloyaltyTestManifest {
        ...
        integrity: MiyuposloyaltyIntegrity {
            fingerprint: fingerprint.to_string(),
            contracts: vec!["Miyuposloyalty-Tool-Governance-Compliance".to_string()],
