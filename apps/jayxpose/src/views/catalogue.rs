                    ...
                    for product in filtered.iter() {
                        {
                            ...
                            rsx! {
                                ProductRow {
                                    ...
                                    on_delete: {
                                        let db_del = db_del.clone();
                                        move |pid: String| {
                                            let _ = db_del.produit_delete(&pid);
                                        }
                                    },
                                }
                            }
            ...
            div {
                ...
                button {
                    ...
                    onclick: {
                        ...
                        let exposant_id = exposant_id.clone();
                        move |_| {
                            ...
                            if !name.is_empty() {
                                ...
                                let _ = db_insert.categorie_insert(&cat);
...

                        {
                            ...
                            rsx! {
                                button {
                                    ...
                                    onclick: move |_| {
                                        let _ = db_del.categorie_delete(&cat_id);
                                    },
                                    "Supprimer"
                                }
                            }
