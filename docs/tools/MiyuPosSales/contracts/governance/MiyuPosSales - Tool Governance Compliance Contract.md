# MiyuPosSales — Tool Governance Compliance Contract
...
## Obligations spécifiques MiyuPosSales

- Aucun Tool n'exécute de **décision métier** (remboursement, remise = StrongFather).
