...
- **[Miyukini Conceptual References — Lois Autonomie Système](../../../../reference/Miyukini%20Conceptual%20References%20-%20Lois%20Autonomie%20Systeme.md)** : Ce contrat respecte **LOI-5** (le coût doit être proportionnel au hardware) en garantissant que le stockage est optimisé pour fonctionner sur des ressources limitées (mini PC, NAS, Raspberry Pi).
