...
| p0-details-index | `.mip/modules/p0-details-index.md` | Début P0 (T3+) — index puis drill-down |
| p0-details | `.mip/modules/p0-details.md` | Détail par temps (Read offset/limit) |
