...
curl "https://miyucloud.example.com/api/i18n/locales"
# [{"code":"en","name":"English"},{"code":"es","name":"Spanish"}, ...]

# Translate a key
curl "https://miyucloud.example.com/api/i18n/translate?key=app.title&locale=es"
# {"key":"app.title","locale":"es","text":"Miyukini Cloud"}

# Get all translations for a locale
curl "https://miyucloud.example.com/api/i18n/locales/en"
# { "app": { "title": "Miyukini Cloud", ... }, "nav": { ... }, ... }
```
