...
pub use board::{create as board_create, get as board_get, list as board_list, update as board_update};
pub use category::{create as category_create, get as category_get, list as category_list, update as category_update};
...
pub use topic::{
    announce as topic_announce,
    create as topic_create,
    export_pdf as topic_export_pdf,
    export_text as topic_export_text,
    get as topic_get,
    list as topic_list,
    sticky as topic_sticky,
