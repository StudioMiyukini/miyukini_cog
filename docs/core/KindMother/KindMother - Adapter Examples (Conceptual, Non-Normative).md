...
- **[Miyukini Framework — Lois Autonomie Système](docs/reference/Miyukini%20Framework%20-%20Lois%20Autonomie%20Systeme.md)** : Les exemples illustrent notamment **LOI-2** (isolement comme état normal), **LOI-3** (état local souverain), et **LOI-6** (autonomie n'empêche pas la fédération)
