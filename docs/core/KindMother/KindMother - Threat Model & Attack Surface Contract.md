...
- **[Miyukini Framework — Lois Autonomie Système](docs/reference/Miyukini%20Framework%20-%20Lois%20Autonomie%20Systeme.md)** : Ce contrat respecte **LOI-1** (aucune dépendance externe critique) en garantissant que la surface d'attaque unique (CoreDataAPI) ne crée pas de dépendances externes critiques, et **LOI-6** (l'autonomie n'empêche pas la fédération) en garantissant que l'isolation entre instances et domaines préserve l'autonomie même dans une fédération.
